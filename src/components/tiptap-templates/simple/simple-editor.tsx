...
// Diadaptasi untuk CMS Wedison: menerima `content` awal + `onChange` (JSON + HTML),
// tanpa theme toggle (situs single-theme), upload gambar ke Media Library backend.
export type SimpleEditorChange = { json: JSONContent; html: string; text: string }
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        ...
        autocorrect: "off",
        autocapitalize: "off",
        "aria-label": placeholder ?? "Area konten utama, mulai mengetik.",
        class: "simple-editor",
      },
    },
    extensions: [
