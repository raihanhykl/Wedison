...
export default function EdmaxPage() {
  ...
  const product: ProductColor[] = [
    ...
    },
    {
      name: "feature2",
      hex: "#FFFFFF",
      alt: "White Edmax Electric Motorcycle",
    },
    {
      name: "hero",
      hex: "#FF0000",
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden">
        <Image
          alt="dash side look"
          src={"/athena-hero.webp"}
          width={9000}
          height={1000}
          className="object-cover inset-0 h-[100vh] lg:object-[40%_100%] object-[75%_100%]"
        />
        {/* dark overlay */}
      ...
      <FeatureSection2
        ...
        // style="bg-gradient-to-r from-black from-0% via-[#151517] to-[#00C6C2]"
      ...
      <FeatureSection2
        ...
        // style="bg-gradient-to-l from-black from-10% via-[#151517] to-[#00C6C2]"
        titleColor="text-white"
        descColor="text-gray-300"
      />
      <ProductPicker
