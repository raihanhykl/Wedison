    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden">
        <Image
          ...
          width={9000}
          height={1000}
          className="object-cover inset-0 h-[100vh] lg:object-[90%_100%] object-[75%_100%]"
        />
        {/* dark overlay */}
        <div className="md:bg-gradient-to-r md:from-black/50 md:from-20% md:to-white/0 absolute max-md:bg-black/60 inset-0 z-10" />
