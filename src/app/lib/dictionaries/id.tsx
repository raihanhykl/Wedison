...
export const id = {
  ...
  "edpower.productPage.chargingHighlight1.description": (
    <>
      Isi daya dari 10% ke 80% hanya dalam 15 menit. Sempurna untuk isi cepat di
      sela aktivitas—tersedia di seluruh showroom Wedison.{" "}
  ...
  "victory.productPage.productHighlight2.title": "Kendali Urban yang Superior",
  ...
  "athena.productPage.chargingHighlight1.description": (
    <>
      ...
      kami—dirancang agar Anda tetap bisa melaju, mengisi daya baterai dari 10%
      hingga 80% hanya dalam 15 menit.{" "}
      <Link href="/super-charge" className="underline text-primary">
        Pelajari Lebih Lanjut
      </Link>
    </>
  ...
  "supercharge.locator.subtitle":
    "Cari titik pengisian SuperCharge terdekat, lihat kapasitas charger, jam operasional, dan fasilitasnya — lalu langsung navigasi ke sana.",
  ...
  "supercharge.locator.geoError":
    "Tidak bisa mendapatkan lokasimu. Coba lagi atau cari kota secara manual.",
  "supercharge.locator.geoDenied":
    "Izin lokasi ditolak. Aktifkan akses lokasi di browser, atau cari kota secara manual.",
  ...
  "supercharge.locator.empty.desc":
    "Coba ubah kata kunci atau filter, atau perluas pencarian ke kota lain.",
  ...
  "supercharge.feature3.subtitle": "Keselamatan dan keandalan adalah prioritas",
  ...
  "form.agreePrivacy.description": (
    <>
      Mengizinkan PT Wedison untuk menggunakan informasi di atas dan menghubungi
      Saya melalui email dan/atau telepon atau sarana komunikasi pribadi lainnya
  ...
  "faq.Servicing.questions.2.question": "Di mana saya dapat melayani EV motor?",
  ...
  "faq.Servicing.questions.8.question": "Apakah modifikasi diizinkan untuk EV?",
